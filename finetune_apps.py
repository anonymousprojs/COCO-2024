...
deepspeed finetune_apps.py --grad-acc-steps=8 --epochs=1 --fp16 --deepspeed fintune/deepspeed_config.json --local_rank 4 --batch-size-per-replica=2
...
from utils.base_lm_dataset import BaseLMDataset
from utils.apps_base_dataset import APPSBaseDataset
from utils.callback import CustomTensorBoardCallback
...
def run_training(args, train_data):
    ...
    pretrain_dir = "finetune/APPS/gpt2-117M"
    # pretrain_dir = "finetune/apps-retrain/03-23-2023__06:01:48/checkpoint-4290"
...
if __name__ == "__main__":
    ...
    # Logging and stuff
    parser.add_argument('--save-dir', default="finetune/apps-retrain/", type=str)
